        ...
        while(true){
          ...
          if (sum==8){
            ...
            hoge:while(true){
              ...
              if (flg[0]==1&&match[x-1][y]>=r) {x-=1;break hoge;}
              else if (flg[1]==1&&match[x][y+1]>=r) {y+=1;break hoge;}
              else if (flg[2]==1&&match[x+1][y]>=r) {x+=1;break hoge;}
              else if (flg[3]==1&&match[x][y-1]>=r) {y-=1;break hoge;}
            }
            continue;
          }
        }
